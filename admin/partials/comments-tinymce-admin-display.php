    ...
    <form method="post" action="<?php echo admin_url( 'admin-post.php' ); ?>" enctype="multipart/form-data">
        ...
        <div class="sticky_popup_form">
            <table class="form-table" width="100%">
                <tr>
                    <th scope="row">Disable H1 Tag</th>
                    <td>
                ...
                <tr>
                    <th scope="row">Disable H2 Tag</th>
                    <td>
                ...
                <tr>
                    <th scope="row">Disable H3 Tag</th>
                    <td>
                ...
                <tr>
                    <th scope="row">Disable H4 Tag</th>
                    <td>
                ...
                <tr>
                    <th scope="row">Disable H5 Tag</th>
                    <td>
                ...
                <tr>
                    <th scope="row">Disable H6 Tag</th>
                    <td>
